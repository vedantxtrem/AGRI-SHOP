...
function Body() {
  return (
    <div class="h-screen w-full sm:textx-xm md:text-2xl flex justify-center items-center ">
      ...
      <iframe src="https://momento360.com/e/u/2790c82f79b64648a703c06fa2bf1c04?utm_campaign=embed&utm_source=other&heading=0&pitch=0&field-of-view=75&size=medium&display-plan=true" className="h-full z-0 w-full ">

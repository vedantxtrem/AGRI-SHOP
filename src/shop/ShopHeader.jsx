...
import logo from './assets/agrihelplogo.png';
...
function ShopHeader() {
  ...
  return (
    <header className="mx-auto flex h-16 max-w-[1200px] items-center justify-between px-5">
      <a href="index.html">
        <img
          className="cursor-pointer sm:h-fit sm:w-fit"
          src=""
          alt="company logo"
        />
      </a>
      ...
      <form className="hidden h-9 w-2/5 items-center border md:flex">
        ...
        <button className="ml-auto h-full bg-green-500 px-4 hover:bg-yellow-300">
          Search
        </button>
      </form>

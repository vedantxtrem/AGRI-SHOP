                ...
                <div className="flex  flex-col items-center   w-full lg:w-1/2 mx-5 my-3">
                    <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
                        <div className="mx-auto max-w-2xl text-center">
                            ...
                            Enter The Information Related To Pest
                            </p>
                        </div>
                        <br />
                        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            ...
                            <div>
                                <input type="file" name="State"
                                    class="ring-1 rounded-full w-full px-4 py-3 bg-green-500 file:from-black file:to-gray-700 file:rounded-3xl   ring-gray-900/10  text-black transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"
                                    placeholder="State" />
                            </div>
                            <div>
                                <button
            ...
            <div className=" w-full">
                ...
                <div className="w-full p-5  md:flex md:justify-between">
                    ...
                    <div className="flex justify-center flex-col items-center  p-5 border-solid border-gray-600 rounded-2xl lg:pr-10 text-2xl sm:w-full md:w-2/3">
                        <h1 className='font-bold text-green-700 text-4xl'>Pest Name</h1>
